...
void mexFunction( int nlhs, mxArray *plhs[],
  ...
  if ( nrhs != 6 ) {
    mexErrMsgIdAndTxt( "MATLAB:sibsoninterpolant:nargin",
        "SIBSONINTERPOLANT requires 6 input arguments" );
  } else if ( nlhs != 1 ) {
    mexErrMsgIdAndTxt("MATLAB:sibsoninterpolant:nargout",
        "SIBSONINTERPOLANT requries 1 output arguments" );
  }
